...
function AppMeasurement() {
  ...
  a.foreachVar = function (c, b) {
    ...
    if (a.lightProfileID)
      (d = a.O),
        (m = a.lightTrackVars) && (m = "," + m + "," + a.ma.join(",") + ",");
    else {
      d = a.g;
      if (a.pe || a.linkType)
        (m = a.linkTrackVars),
  ...
  a.sb = function () {
    ...
    if (a.lightProfileID)
      (b = a.O),
        (n = a.lightTrackVars) && (n = "," + n + "," + a.ma.join(",") + ",");
    else {
      b = a.g;
      if (a.pe || a.linkType)
        (n = a.linkTrackVars),
  ...
  a.D = function (a) {
    ...
    if (
      "undefined" != "" + a.Mb ||
      ("undefined" != "" + a.Cb && "HTML" != ("" + a.Cb).toUpperCase())
    )
      return "";
    ...
    if (a.trackClickMap || a.trackInlineStats || a.ActivityMap) {
      ...
      if (c || a.e) {
        ...
        if (d) {
          ...
          !c &&
            a.e &&
            ((e = a.escape(f.join(",")) + "=" + a.escape(a.e)), (m = 1));
          for (p in b)
            !Object.prototype[p] &&
              0 < m &&
              0 < b[p].length &&
    ...
    if (!d) {
      ...
      try {
        Object.defineProperty
          ? Object.defineProperty(d, "onLoad", { get: d.Xa, set: d.bb })
          : (d._olc = 1);
      } catch (f) {
        d._olc = 1;
      }
  ...
  a.isReadyToTrack = function () {
    ...
    b &&
      ...
      (a.ba ||
        ...
        ((a.ba = !0),
        (a.marketingCloudVisitorID = b.getMarketingCloudVisitorID([a, a.$a])),
        a.marketingCloudVisitorID && (a.U = !0)),
      a.ea ||
        a.visitorOptedOut ||
        !b.isOptedOut ||
        ((a.ea = !0),
        (a.visitorOptedOut = b.isOptedOut([a, a.fb])),
        a.visitorOptedOut != q && (a.V = !0)),
      a.Y ||
        a.analyticsVisitorID ||
        !b.getAnalyticsVisitorID ||
        ((a.Y = !0),
        (a.analyticsVisitorID = b.getAnalyticsVisitorID([a, a.Sa])),
        a.analyticsVisitorID && (a.R = !0)),
      a.aa ||
        ...
        a.audienceManagerLocationHint && (a.T = !0)),
      a.Z ||
        a.audienceManagerBlob ||
        !b.getAudienceManagerBlob ||
        ((a.Z = !0),
        (a.audienceManagerBlob = b.getAudienceManagerBlob([a, a.Ta])),
        a.audienceManagerBlob && (a.S = !0)),
      (c = a.ba && !a.U && !a.marketingCloudVisitorID),
      (b = a.Y && !a.R && !a.analyticsVisitorID),
      (d = a.aa && !a.T && !a.audienceManagerLocationHint),
      (f = a.Z && !a.S && !a.audienceManagerBlob),
      (e = a.ea && !a.V),
      (c = c || b || d || f || e ? !1 : !0));
  ...
  a.t = a.track = function (c, b) {
    ...
    a.visitor &&
      (a.visitor.getAuthState && (a.authState = a.visitor.getAuthState()),
    ...
    a.Ya(c) ||
      ...
      a.wb() &&
        !a.visitorOptedOut &&
        (a.analyticsVisitorID || a.marketingCloudVisitorID || (a.fid = a.qb()),
        a.Bb(),
        ...
        a.account &&
          (a.abort ||
            ...
            a.referrer || a.Ra || (a.referrer = r.document.referrer),
            (a.Ra = 1),
            (a.referrer = a.ob(a.referrer)),
            a.p("_g")),
          a.tb() &&
            !a.abort &&
            (a.ub(), (g += a.sb()), a.Ab(e, g), a.p("_t"), (a.referrer = "")))),
      c && a.Q(d, 1));
    ...
    if ("object" == typeof c)
      if (
        ...
        for (var b = 0; b < c.dests.length; ++b)
          (dest = c.dests[b]),
            "object" == typeof dest &&
              "string" == typeof dest.c &&
              "string" == typeof dest.id &&
              "aa." == dest.id.substr(0, 3) &&
              ((a.ra[dest.id] = new Image()),
              (a.ra[dest.id].alt = ""),
              (a.ra[dest.id].src = dest.c));
  };
  a.mb = function (c) {
    a.i || a.vb();
    a.i.push(c);
  ...
  a.Db = function (c) {
    ...
    b.F = setTimeout(function () {
      b.F &&
        (b.complete
          ? b.ua()
          : (a.trackOffline && b.abort && b.abort(), b.Ca()));
    }, 5e3);
    a.kb = c;
    a.B = k["s_i_" + a.replace(a.account, ",", "_")] = b;
    if ((a.useForcedLinkTracking && a.J) || a.A)
      a.forcedLinkTrackingTimeout || (a.forcedLinkTrackingTimeout = 250),
        (a.ga = setTimeout(a.fa, a.forcedLinkTrackingTimeout));
  };
  a.lb = function () {
    if (a.qa() && !(a.Ja > a.N))
      try {
  ...
  for (n = 0; 250 >= n; n++)
    76 > n && (a.g.push("prop" + n), a.O.push("prop" + n)),
      a.g.push("eVar" + n),
      a.O.push("eVar" + n),
      6 > n && a.g.push("hier" + n),
      4 > n && a.g.push("list" + n);
